...
def test_db_connection_manager_selects_factories_and_closes(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "api_request.cache.sqlite_cache.connection_helpers.create_read_only_connection",
        lambda _db_path: ro_connection,
    )
    monkeypatch.setattr(
        "api_request.cache.sqlite_cache.connection_helpers.create_read_write_connection",
